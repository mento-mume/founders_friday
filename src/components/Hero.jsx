  ...
  return (
    ...
    <section className="hero-section">
      <div className="hero-section__container">
        ...
        >
          <p className="hero-section__headline">
            Join our premier monthly meetup for startup founders and tech
            visionaries
          </p>
          ...
          <button className="hero-section__button">
            Register For Our Next Event <FaArrowRight size={20} />
          </button>
          <p className="hero-section__date">
            Join Us for our next meetup on the 26th of July 2024
          </p>
          <div className="hero-section__collaborators">
            <img
              src={Ellipse1}
              alt="Collaborator 1"
              className="hero-section__collaborator-image"
            />
            <img
              src={Ellipse2}
              alt="Collaborator 2"
          ...
          <p className="hero-section__collaborators-link">
            <span>Become a collaborator today</span>
            <FaArrowUpRightFromSquare size={15} />
          </p>
        </motion.div>
        <div className="hero-section__images-container">
          <div className="hero-section__images-row">
            <img
              src={Frame16}
              alt="image of attendees"
              className="hero-section__image-large"
            />
            <img
              src={Frame17}
              alt="image of attendees"
          ...
          <div className="hero-section__images-row">
            <img
              src={Frame20}
              alt="image of attendees"
              className="hero-section__image-medium"
            />
            <img
              src={Frame22}
              alt="image of attendees"
              className="hero-section__image-small"
            />
          </div>
        </div>
      </div>
