...
const Kaduna = () => {
  return (
    <section className="kaduna" style={{ backgroundImage: `url(${Back})` }}>
      <div className="kaduna__content">
        <div className="kaduna__text-group">
          <p className="kaduna__intro">Founders Friday is coming to</p>
          <h1 className="kaduna__title">Kaduna</h1>
          <p className="kaduna__description">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ac
            rutrum felis. Nulla nibh lorem, facilisis vel est at, vehicula
            dignissim lacus. Cras sagittis imperdiet dolor, eget accumsan leo
            suscipit id. Maecenas ut ante quis quam lobortis consequat eu id
          ...
          <div className="kaduna__cta">
            <button className="kaduna__cta-button">
              <span className="kaduna__cta-button-text">Register</span>
              <FaArrowRight size={20} />
            </button>
          </div>
        </div>
        <div className="kaduna__image-wrapper">
          <img src={logo} alt="Big logo" className="kaduna__image" />
        </div>
      </div>
    </section>
  );
