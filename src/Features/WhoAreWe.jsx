  ...
  return (
    <div className="who-are-we">
      <div className="who-are-we__content">
        <div className="who-are-we__image-container">
          <img
            src={pic}
            alt="group picture of attendees"
        ...
        <div className="who-are-we__text-container">
          <h2 className="who-are-we__heading">Who Are We?</h2>
          ...
          <div className="who-are-we__buttons">
            <button className="who-are-we__button who-are-we__button--register">
              Register <FaArrowRight className="ml-2" />
            </button>

            <button className="who-are-we__button who-are-we__button--donate">
              Donate <FaDonate className="ml-2" />
            </button>
          </div>

          <p className="who-are-we__footer-text">
            Founder&apos;s Friday is more than just a meetup — it&apos;s a
            movement.
          </p>
        </div>
