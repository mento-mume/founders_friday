...
const WhatHappens = () => {
  return (
    <section className="what-happens">
      <div className="what-happens__container">
        <div className="what-happens__text">
          <p className="what-happens__subtitle">Founders Friday</p>
          <h1 className="what-happens__title">
            What Happens At <br className="hidden md:block" /> Founders Friday
          </h1>
          <p className="what-happens__description">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ac
            rutrum felis. Nulla nibh lorem, facilisis vel est at, vehicula
            dignissim lacus. Cras sagittis imperdiet dolor, eget accumsan leo
            suscipit id. Maecenas ut ante quis quam lobortis consequat eu id
          ...
          <button className="what-happens__button">
            Learn More <FaArrowRight className="ml-2" />
          </button>
        </div>

        <div className="what-happens__image-wrapper">
          <img
            src={image1}
            className="what-happens__image"
